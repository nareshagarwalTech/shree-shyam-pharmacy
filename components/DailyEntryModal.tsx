...
const TYPE_OPTIONS: TypeOption[] = [
  ...
  { key: 'transfer',    label: 'Fund Transfer',    emoji: '🔁', description: 'Cash deposit, ATM withdrawal, bank-to-bank',
    longHelp: '💡 Not an income or expense — moves your money from ONE account to another. Examples: 💵 Cash drawer → HDFC (cash deposit at bank), 🏧 HDFC → CASH (ATM withdrawal), 🏦 HDFC → MAHESH BANK (wire transfer). Both account balances adjust; nothing hits sales or expense totals.',
